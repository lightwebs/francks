...
<html <?php language_attributes(); ?> class="no-js">
	<head>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB_OBJT9VmXrBvBfWZ4vYbJg5bEHpxZsS8&callback=initMap&libraries=places"></script>
        <?php /* <script src="<?php echo get_template_directory_uri() . '/src/js/map.js'; ?>" defer></script> */ ?>
