    ...
    <div class="lw-map">
        <div class="lw-map--search">
            <div class="lw-map--search--wrapper">
                <input class="lw-map--search--input" type="text" placeholder="Ort, län eller postnummer">
                <button class="lw-map--search--btn"></button>
            </div>
                <div class="btn-wrapper">
                    <button class="btn btn-primary" id="location-btn">Använd min position</button>
                ...
                <?php foreach( $offices as $o ) :
                    if ( $o->parent != 0 ) :
                        ...
                        $location = get_field('map', $o);
                            ...
                            //     if( isset( $location[ $k ] ) ) {
                            //         $address .= sprintf( '<span class="store-%s">%s</span> ', $k, $location[ $k ] );
                            //     }
                            // }
                ...
                ?>
                        <div class="lw-office-item"
                            ...
                            <div class="btn-wrapper">
                                ...
                                <?php if ( get_field('find_office_link_text', 'options') ) : ?>
                                    <a class="lw-office-item--find-btn btn btn-primary" href="http://maps.apple.com/?daddr=<?php echo $location['address']; ?>&dirflg=d&t=m">
                                        <?php the_field('find_office_link_text', 'options');?>
                                    </a>
                                <?php endif; ?>
                            </div>
                        </div>
